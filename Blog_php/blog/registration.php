...
<html>
    ...
    <body style="background-image: url('http://www.hooli.xyz/assets/photo-cool-people-thumbs-up.jpg');background-size:cover; background-attachment:fixed; background-position:center">
        ...
        <div class="container" style="margin-top:4%;color:white;font-size:20px">
            <div class="col-sm-4 col-sm-offset-4">
            <?php include '../core/regist.php';?>
             </div>
            <div class="col-md-12">
